      ...
      <div className="ltn__utilize-menu-inner ltn__scrollbar">
                  ...
                  <div key={idx} className="mini-cart-item clearfix">
                    ...
                    <div className="mini-cart-info">
                      ...
                      <span className="mini-cart-quantity">
                        {quantity} x {netPrice.toFixed(2)}KM
                      </span>
                    </div>
                  </div>
                );
        ...
        <div className="mini-cart-footer">
          <div className="mini-cart-sub-total">
            <h5>
              Ukupno: <span>{totalPrice.toFixed(2)}KM</span>
            </h5>
          </div>
          <div className="btn-wrapper">
            <ButtonPrimary text={"Pregledaj korpu"} path={"/cart"} />
            <ButtonSecondary text={"Završi kupovinu"} path={"/checkout"} />
          </div>
