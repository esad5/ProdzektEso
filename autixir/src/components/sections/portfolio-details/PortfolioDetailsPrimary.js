...
import sidebarBannerImage from "@/assets/img/banner/banner-2.jpg";
import serviceImage33 from "@/assets/img/service/33.jpg";
import serviceImage34 from "@/assets/img/service/34.jpg";
      ...
      <div className="container">
        <div className="row">
            ...
            <div className="ltn__page-details-inner ltn__service-details-inner">
              ...
              <div className="row">
                <div className="col-lg-6">
                  <Image src={serviceImage33} alt="image" />
                  <label>Image caption here.</label>
                </div>
                <div className="col-lg-6">
                  <Image src={serviceImage34} alt="image" />
                </div>
              </div>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
          ...
          <div className="col-lg-4">
            <ServiceSidebar image={sidebarBannerImage} />
          </div>
        </div>
      </div>
    </div>
