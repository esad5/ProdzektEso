          ...
          <div className="col-lg-8">
            <div className="ltn__blog-details-wrap">
              <div className="ltn__page-details-inner ltn__blog-details-inner">
                ...
                <Image src={image} alt="Slika" placeholder="blur" />
                <h2>Osvježavajući topli tuš ili kupka</h2>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                  Ut enim ad minim veniam, quis nostrud exercitation ullamco
                  ...
                  irure dolor in reprehenderit in voluptate velit esse cillum
                  dolore eu fugiat nulla pariatur. Excepteur sint occaecat
                  cupidatat non proident, sunt uin culpa qui officia.{" "}
                </p>
                <hr />
                <h2>Stvaranje atmosfere uz tamjan</h2>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                  Ut enim ad minim veniam, quis nostrud exercitation ullamco
                ...
                <blockquote>
                  <h6 className="ltn__secondary-color mt-0">AUTOR: HETMAYAR</h6>
                ...
                <p>
                  ...
                  irure dolor in reprehenderit in voluptate velit esse cillum
                  dolore eu fugiat nulla pariatur. Excepteur sint occaecat
                  cupidatat non proident, sunt uin culpa qui officia deserunt
                  mollit anim id est laborum. Sed ut perspiciatis unde omnis
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <Image src={servceImage31} alt="Slika" placeholder="blur" />
                    <label>Naslov slike ovdje</label>
                  </div>
                  <div className="col-lg-6">
                    <Image src={servceImage32} alt="Slika" placeholder="blur" />
                  </div>
                </div>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              ...
              <div className="ltn__blog-tags-social-media mt-80 row">
                ...
                <div className="ltn__social-media text-right text-end col-lg-4">
                  <h4>Dijeljenje na društvenim mrežama</h4>
                  <ul>
                    <li>
              ...
              {relatedBlogs?.length ? (
                <div className="related-post-area mb-50">
                  <h4 className="title-2">Povezani postovi</h4>
                  <div className="row">
              ...
              <div className="ltn__comment-area mb-50" id="comments">
                <div className="ltn-author-introducing clearfix">
                  <div className="author-img">
                    <Image src={author?.image} alt="Slika autora" />
                  </div>
                ...
                <h4 className="title-2">{totalComments} Komentara</h4>
                {commentsLength ? (
                          ...
                          <li key={idx}>
                            <div className="ltn__comment-item clearfix">
                              ...
                              <div className="ltn__commenter-comment">
                                ...
                                >
                                  <i className="icon-reply-1"></i>Odgovori
                                </Link>
                              </div>
                            </div>
                            {replies?.length ? (
              ...
              <div
                ...
                id="comment_form"
              >
                <h4 className="title-2">Postavi komentar</h4>
                <form action="">
                  <div className="input-item input-item-textarea ltn__custom-icon">
                    <textarea placeholder="Upiši svoj komentar...." />
                  </div>
                  <div className="input-item input-item-name ltn__custom-icon">
                    <input type="text" placeholder="Upiši svoje ime...." />
                  </div>
                  ...
                  <div className="input-item input-item-website ltn__custom-icon">
                    <input
                      type="text"
                      name="website"
                      placeholder="Upiši svoj web sajt...."
                    />
                  </div>
                  <label className="mb-0 input-info-save">
                    <input type="checkbox" name="agree" /> Sačuvaj moje ime, email,
                    i web sajt u ovom pretraživaču za sljedeći put kad komentarišem.
                  </label>
                  <div className="btn-wrapper">
                    <button
                      ...
                      type="submit"
                    >
                      <i className="far fa-comments"></i> Pošalji komentar
                    </button>
                  </div>
                </form>
              </div>
